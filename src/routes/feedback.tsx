...
export const Route = createFileRoute("/feedback")({
  head: () => ({
    meta: [
      { title: "Feedback — Fitsters Club Jhalawar" },
      { name: "description", content: "Share your genuine suggestions with Fitsters Club Jhalawar so we can keep improving equipment, classes and service." },
      { property: "og:title", content: "Feedback — Fitsters Club Jhalawar" },
