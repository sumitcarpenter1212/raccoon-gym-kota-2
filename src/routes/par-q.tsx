...
export const Route = createFileRoute("/par-q")({
  head: () => ({
    meta: [
      { title: "PAR-Q Form — Fitsters Club Jhalawar" },
      { name: "description", content: "Complete the Physical Activity Readiness Questionnaire (PAR-Q) online before starting training at Fitsters Club Jhalawar." },
      { property: "og:title", content: "PAR-Q Form — Fitsters Club Jhalawar" },
