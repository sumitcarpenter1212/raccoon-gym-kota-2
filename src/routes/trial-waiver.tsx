...
export const Route = createFileRoute("/trial-waiver")({
  head: () => ({
    meta: [
      { title: "Trial Waiver & Release Form — Fitsters Club Jhalawar" },
      { name: "description", content: "Sign the trial waiver and release form online to book your free trial session at Fitsters Club Jhalawar." },
      { property: "og:title", content: "Trial Waiver — Fitsters Club Jhalawar" },
...
const WAIVER = [
  ...
  "I release Fitsters Club Jhalawar, its owners, trainers and staff from liability for injury or loss arising from my participation, except in the case of proven negligence.",
