...
export const Route = createFileRoute("/book-pt")({
  ...
  head: () => ({
    meta: [
      { title: "Book A Personal Training Session — Atmos Fitness Kota" },
      { name: "description", content: "Book one-on-one personal training at Atmos Fitness Kota. Choose your trainer, plan and preferred slot." },
      { property: "og:title", content: "Book Personal Training — Atmos Fitness Kota" },
